...
// Instantiation of Axi Bus Interface S00_AXI
	...
	// Add user logic here
        ...
        always @*
          if (vblnk_d || hblnk_d) rgb_out_nxt = 12'h0_0_0; 
          else if( hcount_d > 127 && hcount_d <1152) rgb_out_nxt = rgb_bg;
          else rgb_out_nxt = rgb_sides;
    
        always @* begin
            if( hcount_in > 127 && hcount_in <1152) yaddr = vcount_in + shift_bg;
            else yaddr = vcount_in + shift_sides;
