...
##USB HID (PS/2)
#set_property PACKAGE_PIN C17 [get_ports ps2_clk_usb]						
#	set_property IOSTANDARD LVCMOS33 [get_ports ps2_clk_usb]
#	set_property PULLUP true [get_ports ps2_clk_usb]
#set_property PACKAGE_PIN B17 [get_ports ps2_data_usb]					
#	set_property IOSTANDARD LVCMOS33 [get_ports ps2_data_usb]	
#	set_property PULLUP true [get_ports ps2_data_usb]
