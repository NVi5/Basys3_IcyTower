...
##Pmod Header JB
##Sch name = JB1
set_property PACKAGE_PIN A14 [get_ports ps2_clk_out]					
	set_property IOSTANDARD LVCMOS33 [get_ports ps2_clk_out]
##Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports ps2_data_out]					
	set_property IOSTANDARD LVCMOS33 [get_ports ps2_data_out]
##Sch name = JB3
